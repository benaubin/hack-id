...
class CreateDoorkeeperTables < ActiveRecord::Migration[6.0]
  def change
    ...
    create_table :oauth_access_grants, id: :uuid do |t|
      t.references :resource_owner,  null: false, foreign_key: { to_table: :members }, type: :uuid
    ...
    create_table :oauth_access_tokens, id: :uuid do |t|
      t.references :resource_owner, index: true, foreign_key: { to_table: :members }, type: :uuid
